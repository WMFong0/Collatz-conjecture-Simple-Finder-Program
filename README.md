...
A small project I created back in 2022, haven't had the time to fix the bugs. Now it should be all settled. Currently thinking about adding multi-threading (should be coming quite soon) and possibly a matplotlib graph.
